...
2. Dominos connect to matching Pip values.
3. Dominos must be connected on both ends.
4. Dominos cannot be connected in flush parallel.
5. Find the best paths! Create paths, loops, and shortcuts.
